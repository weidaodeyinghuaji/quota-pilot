...
assert.doesNotMatch(source, /const isDetailWindow = urlParams\.get\('view'\) === 'detail';/);
...
assert.doesNotMatch(source, /detail-window-shell/);
assert.doesNotMatch(source, /detail-window-popover/);
