...
assert.match(electronMain, /desktop-quota-alert/);
...
assert.match(electronMain, /function getDisplayForCapsuleBounds/);
assert.match(electronMain, /getDisplayForCapsuleBounds\(currentCapsuleScreen/);
assert.match(electronMain, /screen\.getDisplayMatching\(candidate\)/);
...
assert.match(electronMain, /desktop-live-data-publish/);
assert.match(electronMain, /desktop-live-data-request/);
assert.match(electronPreload, /onDataInvalidated/);
assert.match(electronPreload, /publishLiveData/);
assert.match(electronPreload, /requestLiveData/);
assert.match(electronPreload, /onLiveData/);
